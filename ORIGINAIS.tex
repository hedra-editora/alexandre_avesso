...
\addcontentsline{toc}{chapter}{In absentia}
\bigskip
...
--- A Mônica foi"-se embora e não deixou morada.
...
duas, a conversar, ouvir \versal{CD}s e beber café de um termos.
...
PEQUENA COMO PARA O IMENSO MUNDO. OS ATOS, SABES, TÊM CONSEQUÊNCIAS.
...
A carta anônima (\versal{``TU QUERES UM PÁSSARO NA MÃO E OS DOIS QUE VOARAM COMO
...
Ao chegar a casa, tinha à sua espera a segunda carta anônima.
...
A TUA DECISÃO NÃO É O ALFA E O ômEGA
...
SABES E EU TRAREI AQUILO QUE SABES. NÃO FALTES, MÔNICA.}
\end{quotation}
...
--- Diga"-lhe que isto não faz parte do contrato --- o rosto do homem
  ...
  de respeito e, não me importo de usar a palavra, de \versal{AMOR}, não sei o
...
Ficou a pé até quatro da madrugada, entretido a pesquisar
...
\begin{quotation}
\versal{E ASSIM É. TUDO ESTRANHAMENTE NO SEU LUGAR. EIS POIS A TUA OBRA, MÔNICA.
...
}UMA VÊNIA PARA TI, MÔNICA, UMA VÊNIA QUE TE PERSIGA E QUE TE VISITE
...
Mônica, satisfeita por poder partilhar o seu itinerário íntimo de
...
Mônica que afinal detestava infusão de menta. A saqueta que deixara em
...
\addcontentsline{toc}{chapter}{Quarto escuro}
\bigskip
...
pessoa. Fingi procurar um \versal{CD}, fingi hesitar entre a \emph{Méditation
...
--- Não me ocorre nenhum --- respondi, voltando"-me para ela, um \versal{CD} em cada
...
\addcontentsline{toc}{chapter}{Quem anda a comer do meu prato?}
\bigskip
...
Nessa mesma tarde, recebi um \versal{SMS} com um local, uma data, uma hora e um
...
caracterizaram as primeiras décadas do século \versal{XX}, embora se tratasse de
...
\movetooddpage\vspace*{1.8cm}
\noindent{}\textbf{Sul}
\addcontentsline{toc}{chapter}{Sul}
\bigskip
...
Lucrecia devia à sua saúde frágil o fato de receber em casa a educação
...
\addcontentsline{toc}{chapter}{Vaga de fundo}
\bigskip
...
\emph{\versal{TV} Cabo e Internet de banda larga}
...
--- Não sei\ldots{} Acabei de chegar de X\ldots{} --- Ágata pronunciou o nome da
...
Ágata acabou de desfazer a mala. Os seus poucos objetos pessoais
...
--- As festas, por exemplo, custam pequenas fortunas. É preciso pagar ao
  \versal{DJ}, pagar as bebidas, pagar o aluguer do espaço. As entradas não
...
--- Ele deixou a vida acadêmica sem concluir o curso. Há quem diga que
...
Laboratórios de Química \versal{II} e Química Orgânica. O frio insinuava"-se nas
...
\addcontentsline{toc}{chapter}{Voi che sapete}
\bigskip
...
desconforto. Quase todos os livros, cerca de dois terços dos \versal{CD}s e
...
primeira metade do século \versal{XX}, Joaquim Paço d'Arcos, Raul Brandão, Manuel
...
Partilhavam o leitor de \versal{MP3}, um auricular no ouvido direito de
...
\addcontentsline{toc}{chapter}{O ramo dourado 2012 --- Uma nova esperança}
\bigskip
...
\addcontentsline{toc}{chapter}{Rua da velha lanterna}
\bigskip
...
de l'Hôtel de Ville, Quai des Célestins, Quai Henri \versal{IV}, Quai de la
...
O homem que servira de protetor a Winna nos seus primeiros tempos em
...
Jim Morrison, poeta e vocalista da banda The Doors, morreu na noite de
...
português e brasileiro do século \versal{XIX} e procurava alguém para rever as
...
literatura do século \versal{XIX} do que um qualquer amador esforçado, mas a
...
(ou seja, \versal{PESSOA}) como a ambição máxima a que se pode aspirar. Nesse
...
Dentro da mala encontramos apenas um exemplar de \emph{Splendeurs et
...
\addcontentsline{toc}{chapter}{O mesmo poeta}
\bigskip
...
dele de gestão no \versal{ISEG}, uma ou outra saída à noite, a dois ou com
amigos, sessões de \emph{poker }pela noite dentro, maratonas de séries
no \versal{AXN}. Aos poucos, recuperávamos a intimidade perdida. O meu desprezo
...
--- Estou a citar. Achas normal? Estas alusões transformaram"-se numa
  ...
  então que o seu interesse pela poesia russa do início do século \versal{XX},
...
--- Admito que bate certo com o seu feitio rebelde, com o espírito que o
  ...
  positivismo do século \versal{XIX}, a obsessão pelo ideal, pelo incorpóreo,
...
--- Pode ser uma estratégia para definir quem de fato está do seu lado.
