...
\huge{\textbf{Quartos alugados}} \hspace*{1.25cm}
...
\emph{Quartos alugados}, Porto, Exclamação, 2015
...
A553\\
Andrade, Alexandre\\
Quartos alugados / Alexandre Andrade. -- Rio de Janeiro: Circuito; Lisboa: \versal{DGLAB}, 2020. (Coleção Trás-os-mares).\\
144 p.\\[2pt]

\versal{ISBN} 978-65-8697-415-7\\[2pt]

1. Literatura Portuguesa. 2. Conto. I. Título. II. Série. III. Direção-Geral do Livro, dos Arquivos e das Bibliotecas (\versal{DGLAB}).\\
...
\LARGE{\versal{Alexandre Andrade}} \hspace*{1.3cm}
